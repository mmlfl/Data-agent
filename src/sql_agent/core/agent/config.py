...
class AgentConfig(BaseModel):
    ...
    auto_finalize_results: bool = Field(default=True)
    finalizer_tool_name: str = Field(default="finalize_result", min_length=1)
    max_finalize_rows: int = Field(default=20, gt=0, le=100)
